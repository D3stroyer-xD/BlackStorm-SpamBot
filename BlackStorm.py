...
from helpmenu import spam_menu, curse_menu, sudo_menu, dev_menu, acc_menu, help_menu, alive_temxt, storm_logo, start_caption, start_caption1, devusage, sudousage, spamusage, accusage

storm_logo = "https://telegra.ph/file/d6aef4876f4cb8cc00bf5.jpg"

buttons = [
    [
        (Button.url("Cʜᴀɴɴᴇʟ", url="https://t.me/II_ROYALSOCIETY_II")),
        (Button.url("Sᴜᴘᴘᴏʀᴛ", url="https://t.me/TEAM_BLACKSTORM"))
    ],
    [
        (Button.url("Rᴇᴘᴏ", url="https://github.com/D3stroyer-xD/BlackStorm-SpamBot")),
        (Button.url("Tᴜᴛᴏʀɪᴀʟ", url="https://t.me/TEAM_BLACKSTORM"))
    ]
]
...
async def gladiators_bots():
    ...
    if String_Session01:
        ...
        try:
            ...
            await Bot1.start()
            mat = "https://t.me/TEAM_Blackstorm"
...
async def _(event):
    ...
    async with event.client.action(event.chat_id, "typing"):
        await event.client.send_message(
            ...
            message="""{}""".format(random.choice(replies)),
...
async def _(dyno):
    ...
    await dyno.client.send_file(
        ...
        reply_to=dyno.id,
        force_document=True,
        thumb="resources/blackstorm.jpeg",
        caption="@TEAM_BLACKSTORM spammerbots logs.",
    )
...
async def alive(e):
    ...
    if '-' not in xd:
        ...
        if not xd.bot:
            await e.client.send_file(e.chat_id, storm_logo, caption = start_caption1, link_preview=None)
        else:
...
async def _(event):
    if event.sender_id in DEV_USERS:
        try:
            black = await event.get_reply_message()
            try:
                media = await black.download_media( "spammerbots/downloads/")
            except:
                pass
...
print("Starting BlackStorm Spammerbots...")
print("Started....")
